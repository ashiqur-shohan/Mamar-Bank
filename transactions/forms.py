...
class TransferForm(forms.Form):
    ...
    #     if UserBankAccount.objects.get(account_no=account_no):
    #         raise forms.ValidationError(f'{account_no} account is not registered')
    #     return account_no
    # def clean_amount(self):
    #     amount = self.cleaned_data.get('amount')
    #     balance = self.account.balance
    #     if amount > balance:
    #         raise forms.ValidationError(f'{amount} exceds your balance')
    #     return amount
